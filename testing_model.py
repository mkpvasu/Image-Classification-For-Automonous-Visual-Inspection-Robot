...
class ModelTest:
    def __init__(self, micron, batch_size=4):
        ...
        self.model_attributes, self.trained_model = \
            ModelTrain(train_data_path=self.train_data_path, save_model_attributes_path=self.save_model_attributes_path,
                       micron="20_micron", n_epochs=2, batch_size=self.batch_size).output_trained_model()
    ...
    def save_model_features(self):
        ...
        performance_attributes["model_f1_score"] = float(model_f1_score)
