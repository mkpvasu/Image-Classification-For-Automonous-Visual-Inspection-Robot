...
class ModelTrain:
    ...
    def __init__(self, train_data_path, save_model_attributes_path, micron, model=resnet50, weights=ResNet50_Weights.IMAGENET1K_V2,
                 ...
                 optimizer_lr=0.005, model_lr_scheduler_gamma=0.95, n_epochs=5, batch_size=64, train_val_split=0.2):
        ...
        self.train_loader = DataLoader(dataset=self.train_dataset, batch_size=self.batchSize, shuffle=True, num_workers=4)
        self.val_loader = DataLoader(dataset=self.val_dataset, batch_size=self.batchSize, shuffle=True, num_workers=4)
